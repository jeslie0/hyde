...
#+BEGIN_SRC latex :fit yes :file ../mages/unity-pentagon.png :imagemagick yes :iminoptions -density 600  :headers '("\\usepackage{tikz-cd} \\usepackage{math-packages} \\usepackage{math-macros}") :results none
% \definecolor{col1}{HTML}{D8DEE9}
 \begin{tikzcd}
...
[[file:../images/unity-pentagon.png]]
#+END_definition
...
#+BEGIN_SRC latex :fit yes :file ./Images/monoidalcat-1.png :imagemagick yes :iminoptions -density 600  :headers '("\\usepackage{tikz-cd} \\usepackage{math-packages} \\usepackage{math-macros}") :results none
\definecolor{col1}{HTML}{D8DEE9}
\begin{tikzcd}
...
[[file:./images/monoidalcat-1.png]]

We can apply the functor \( - \otimes 0\) to this square to get the following square:
#+BEGIN_SRC latex :fit yes :file ../images/monoidalcat-2.png :imagemagick yes :iminoptions -density 600  :headers '("\\usepackage{tikz-cd} \\usepackage{math-packages} \\usepackage{math-macros}") :results none
\definecolor{col1}{HTML}{D8DEE9}
\begin{tikzcd}
...
#+END_SRC
#+attr_html: :width 200px
[[file:../images/monoidalcat-2.png]]

Factoring \( 1_{I \otimes 0} = \lambda_0^{-1} \circ \lambda_0\) gives the following diagram:

#+BEGIN_SRC latex :fit yes :file ../images/monoidalcat-3.png :imagemagick yes :iminoptions -density 600  :headers '("\\usepackage{tikz-cd} \\usepackage{math-packages} \\usepackage{math-macros}") :results none
\definecolor{col1}{HTML}{D8DEE9}
